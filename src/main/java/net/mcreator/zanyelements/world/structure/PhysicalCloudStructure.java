...
import net.mcreator.zanyelements.procedures.PhysicalCloudOnStructureInstanceGeneratedProcedure;
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false));
						{
							...
							PhysicalCloudOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
