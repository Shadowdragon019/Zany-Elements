...
public class WaystoneIronStructure extends ZanyelementsModElements.ModElement {
	public WaystoneIronStructure(ZanyelementsModElements instance) {
		super(instance, 113);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "iron_waystone"));
						if (template == null)
							return false;
