...
import net.mcreator.zanyelements.procedures.WaystoneFireOnStructureInstanceGeneratedProcedure;
...
public class WaystoneEmeraldStructure extends ZanyelementsModElements.ModElement {
	public WaystoneEmeraldStructure(ZanyelementsModElements instance) {
		super(instance, 116);
			...
			public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 500) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!WaystoneFireOnStructureInstanceGeneratedProcedure
								.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
							continue;
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "emerald_waystone"));
						if (template == null)
							return false;
