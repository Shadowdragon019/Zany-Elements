...
public class HoleStructure extends ZanyelementsModElements.ModElement {
	public HoleStructure(ZanyelementsModElements instance) {
		super(instance, 111);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "hole"));
						if (template == null)
							return false;
