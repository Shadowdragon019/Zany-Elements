...
public class OakWebStructure extends ZanyelementsModElements.ModElement {
	public OakWebStructure(ZanyelementsModElements instance) {
		super(instance, 105);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "oak_web"));
						if (template == null)
							return false;
