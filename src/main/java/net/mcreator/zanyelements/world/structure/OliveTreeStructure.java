...
import net.mcreator.zanyelements.procedures.OliveTreeOnStructureInstanceGeneratedProcedure;
				...
				if ((random.nextInt(1000000) + 1) <= 1000000) {
					...
					for (int a = 0; a < count; a++) {
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false), random);
						{
							...
							OliveTreeOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
