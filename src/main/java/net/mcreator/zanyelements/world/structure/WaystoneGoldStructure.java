...
public class WaystoneGoldStructure extends ZanyelementsModElements.ModElement {
	public WaystoneGoldStructure(ZanyelementsModElements instance) {
		super(instance, 114);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "gold_waystone"));
						if (template == null)
							return false;
