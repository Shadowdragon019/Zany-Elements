...
public class GoldenChaliceCloudStructure extends ZanyelementsModElements.ModElement {
	public GoldenChaliceCloudStructure(ZanyelementsModElements instance) {
		super(instance, 234);
				...
				if ((random.nextInt(1000000) + 1) <= 750) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "golden_chalice_cloud"));
						if (template == null)
							return false;
