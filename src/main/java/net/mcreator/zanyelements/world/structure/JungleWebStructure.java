...
public class JungleWebStructure extends ZanyelementsModElements.ModElement {
	public JungleWebStructure(ZanyelementsModElements instance) {
		super(instance, 109);
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "jungle_web"));
						if (template == null)
							return false;
