...
public class WaystoneDiamondStructure extends ZanyelementsModElements.ModElement {
	public WaystoneDiamondStructure(ZanyelementsModElements instance) {
		super(instance, 115);
				...
				if ((random.nextInt(1000000) + 1) <= 500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("zanyelements", "diamond_waystone"));
						if (template == null)
							return false;
