...
public class SnowBricksBlock extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:snow_bricks")
	public static final Block block = null;
	public SnowBricksBlock(ZanyelementsModElements instance) {
		super(instance, 170);
	}
