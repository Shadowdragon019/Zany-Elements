...
public class OliveLogBlock extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:olive_log")
	public static final Block block = null;
	public OliveLogBlock(ZanyelementsModElements instance) {
		super(instance, 98);
	}
