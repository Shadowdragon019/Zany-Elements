...
public class OliveWoodBlock extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:olive_wood")
	public static final Block block = null;
	public OliveWoodBlock(ZanyelementsModElements instance) {
		super(instance, 129);
	}
