...
public class OliveDoorBlock extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:olive_door")
	public static final Block block = null;
	public OliveDoorBlock(ZanyelementsModElements instance) {
		super(instance, 141);
	}
