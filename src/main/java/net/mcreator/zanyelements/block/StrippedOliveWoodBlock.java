...
public class StrippedOliveWoodBlock extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:stripped_olive_wood")
	public static final Block block = null;
	public StrippedOliveWoodBlock(ZanyelementsModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_olive_wood");
		}
