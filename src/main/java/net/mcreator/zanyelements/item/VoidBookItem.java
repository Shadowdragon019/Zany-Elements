...
import net.mcreator.zanyelements.gui.VoidBookGGui;
...
public class VoidBookItem extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:void_book")
	public static final Item block = null;
	public VoidBookItem(ZanyelementsModElements instance) {
		super(instance, 250);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof VoidBookGGui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Void Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new VoidBookGGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
