...
import net.mcreator.zanyelements.procedures.IceMirrorRangedItemUsedProcedure;
...
public class IceMirrorItem extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:ice_mirror")
	public static final Item block = null;
	@ObjectHolder("zanyelements:entitybulletice_mirror")
	public static final EntityType arrow = null;
	public IceMirrorItem(ZanyelementsModElements instance) {
		super(instance, 277);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletice_mirror").setRegistryName("entitybulletice_mirror"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						IceMirrorRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
