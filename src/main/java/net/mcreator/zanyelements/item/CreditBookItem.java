...
import net.mcreator.zanyelements.gui.CreditBookGUIGui;
...
public class CreditBookItem extends ZanyelementsModElements.ModElement {
	@ObjectHolder("zanyelements:credit_book")
	public static final Item block = null;
	public CreditBookItem(ZanyelementsModElements instance) {
		super(instance, 117);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CreditBookGUIGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Credits to all those who helped me!"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Credit Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CreditBookGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
