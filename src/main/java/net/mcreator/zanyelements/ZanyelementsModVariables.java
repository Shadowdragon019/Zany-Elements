...
public class ZanyelementsModVariables {
	public ZanyelementsModVariables(ZanyelementsModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote) {
			...
			if (mapdata != null)
				ZanyelementsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "zanyelements_worldvars";
		public boolean AmazingVariable = false;
		...
		public void read(CompoundNBT nbt) {
			AmazingVariable = nbt.getBoolean("AmazingVariable");
		}

		@Override
		public CompoundNBT write(CompoundNBT nbt) {
			nbt.putBoolean("AmazingVariable", AmazingVariable);
			return nbt;
		}
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				ZanyelementsMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
	...
	public static class MapVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (!world.getWorld().isRemote)
				ZanyelementsMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("zanyelements", "player_variables"), new PlayerVariablesProvider());
	}
