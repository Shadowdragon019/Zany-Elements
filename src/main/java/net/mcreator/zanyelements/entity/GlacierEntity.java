...
import net.mcreator.zanyelements.procedures.GlacierOnInitialEntitySpawnProcedure;
...
public class GlacierEntity extends ZanyelementsModElements.ModElement {
	public static EntityType entity = null;
	public GlacierEntity(ZanyelementsModElements instance) {
		super(instance, 185);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("glacier")
						.setRegistryName("glacier");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -16737895, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("glacier_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zanyelements:textures/glacier.png");
					}
				};
