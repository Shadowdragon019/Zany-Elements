	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure CoreCraftingTableGUIWhileThisGUIIsOpenTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure CoreCraftingTableGUIWhileThisGUIIsOpenTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure CoreCraftingTableGUIWhileThisGUIIsOpenTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure CoreCraftingTableGUIWhileThisGUIIsOpenTick!");
			return;
		}
		...
		for (int index0 = 0; index0 < (int) (9); index0++) {
			...
			if ((new ItemStack(Blocks.STONE_BUTTON, (int) (1)).getItem() == (new Object() {
				...
				if (!world.getWorld().isRemote) {
					...
					BlockState _bs = world.getBlockState(_bp);
					if (_tileEntity != null)
						_tileEntity.getTileData().putString("outputName", "1x Stone");
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
				break;
