...
public class BlockRightClickedProcedure extends ZanyelementsModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:totem_chisel_tool").toLowerCase(java.util.Locale.ENGLISH)))
				...
				|| (ItemTags.getCollection().getTagByID(new ResourceLocation(("logs").toLowerCase(java.util.Locale.ENGLISH)))
						.contains(((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemOffhand() : ItemStack.EMPTY).getItem())))
				&& (BlockTags.getCollection().getTagByID(new ResourceLocation(("forge:totem_wood").toLowerCase(java.util.Locale.ENGLISH)))
